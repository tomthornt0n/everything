...
cl.exe %compile_flags% %compile_options% /DApplicationName="%app_name%" ..\source\visidesk\visidesk_test_main.c fonts.obj /link %link_flags%  /out:"%app_name%_debug.exe"
...
set link_flags= /opt:ref /incremental:no /subsystem:windows /DEBUG:FULL
cl.exe %compile_flags% %compile_options% /DApplicationName="%app_name%" ..\source\visidesk\visidesk_test_main.c fonts.obj /link %link_flags%  /out:"%app_name%.exe"
